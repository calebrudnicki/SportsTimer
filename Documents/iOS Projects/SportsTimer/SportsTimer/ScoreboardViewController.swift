...
//MARK: Layout Functions
    ...
    func activatePhone() {
        ...
        player1Button.setTitleColor(UIColor(red: 235/255, green: 235/255, blue: 235/255, alpha: 1), forState: .Normal)
        player2Button.setTitleColor(UIColor(red: 235/255, green: 235/255, blue: 235/255, alpha: 1), forState: .Normal)
    ...
    func deactivatePhone() {
        ...
        player1Button.setTitleColor(UIColor(red: 22/255, green: 160/255, blue: 133/255, alpha: 1), forState: .Normal)
        player2Button.setTitleColor(UIColor(red: 22/255, green: 160/255, blue: 133/255, alpha: 1), forState: .Normal)
...
//MARK: Watch Communication Functions
    ...
    @IBAction func player1ButtonTapped(sender: AnyObject) {
        ...
        player1Button.setTitle(String(player1Score), forState: .Normal)
    }
    
    //This function adds one to player 2 when the button is tapped
    @IBAction func player2ButtonTapped(sender: AnyObject) {
        player2Score = player2Score + 1
        player2Button.setTitle(String(player2Score), forState: .Normal)
    }
...
//MARK: Label Functions
    ...
    func restartGame() {
        ...
        player1Score = 0
        player2Score = 0
        player1Button.setTitle("0", forState: .Normal)
        player2Button.setTitle("0", forState: .Normal)
    }
    
    //This functions updates the score labels to match the watch's data
    func displayLabels(dataDict: [String : AnyObject]) {
        player1Button.setTitle(String(dataDict["Score1"]!), forState: .Normal)
        player2Button.setTitle(String(dataDict["Score2"]!), forState: .Normal)
...
//MARK: Timer Functions
    ...
    func timesUp(winner: String) {
        ...
        if winner == "Player1" {
            player1Button.titleLabel?.tintColor = UIColor.greenColor()
            player2Button.titleLabel?.tintColor = UIColor.redColor()
        } else if winner == "Player2" {
            player2Button.titleLabel?.tintColor = UIColor.greenColor()
            player1Button.titleLabel?.tintColor = UIColor.redColor()
        } else if winner == "Tie" {
            player1Button.titleLabel?.tintColor = UIColor.blueColor()
            player2Button.titleLabel?.tintColor = UIColor.blueColor()
        }
    }
